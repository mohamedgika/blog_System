  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4"">
    ...
    <a href="" class="brand-link">
      <img src="{{asset('imgs/'.$set->logos)}}" alt="News Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">{{LaravelLocalization::getCurrentLocaleDirection() == 'ltr' ? $set->getTranslation('title','en') : $set->getTranslation('title','ar') }} {{__('backend/dashboard_main_sidbar.Dashboard')}}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('imgs/'.$set->logos)}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
