  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4"">
    ...
    <a href="" class="brand-link">
      <img src="{{isset($set) == true ? asset('imgs/'.$set->logos) : asset('imgs/category/news.png')}}" alt="News Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ isset($set) == true ? asset('imgs/'.$set->logos) : asset('imgs/category/news.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
